    ...
    with tf.variable_scope(scope):
      ...
      with tf.variable_scope('word') as scope:
        ...
        with tf.variable_scope('dropout'):
          ...
          self.word_level_output_dropout = word_level_output
      ...
      with tf.variable_scope('sentence') as scope:
        ...
        with tf.variable_scope('attention') as scope:
          ...
          self.sentence_level_output = sentence_level_output
        ...
        with tf.variable_scope('dropout'):
          ...
          self.sentence_level_output_dropout = sentence_level_output
...
if __name__ == '__main__':
  ...
  with tf.Session() as session:
    ...
    print("------")
    print(session.run([model.document_size,model.sentence_size,model.word_size],fd))
    print("------")
    print(session.run([model.word_lengths,model.sentence_lengths],fd))
    print("------")
    print(session.run([model.inputs,model.labels],fd))
